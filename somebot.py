...
driver = webdriver.Chrome(r"C:\Users\jadkh\Downloads\chromedriver_win32 (3)\chromedriver.exe")
...
def check_out():
    ...
    ''''' Date '''''
    actions.send_keys(Keys.NUMPAD0)
    actions.send_keys(Keys.NUMPAD8)
    actions.send_keys(Keys.NUMPAD2)
    actions.send_keys(Keys.NUMPAD5)
    '''' CVV '''
    actions.send_keys(Keys.NUMPAD2)
    ...
    email.send_keys("Jad.Kharboutly@gmail.com")
    phone.send_keys("6478770325")
    name.send_keys("Jad")
    nameLast.send_keys("Kharboutly")
    address.send_keys("2141 Laurelwood Dr")
    city.send_keys("Oakville")
    postalCode.send_keys("L6H4T2")
    time.sleep(5)
